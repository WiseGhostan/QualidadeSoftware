...
#Define BASE_DIR como o diretório raiz do projeto, subindo dois níveis acima do arquivo atual
BASE_DIR = os.path.dirname(os.path.dirname(os.path.abspath(__file__)))
#Adiciona o diretório apps dentro da lista de caminhos do Python
